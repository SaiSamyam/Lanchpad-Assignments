...
while True:
    ...
    if ch == 1:
        ...
        rn = int(input('Enter roll number of student whose revalprint(tabulate([(1,'UPDATE MARKS IN MATHEMATICS'),(2,'UPDATE MARKS IN SCIENCE'),(3,'UPDATE MARKS IN SOCIAL SCIENCE'),(4,'UPDATE MARKS IN ENGLISH'),(5,'UPDATE MARKS IN LANGUAGE'),(6,'DONE')]))
        Student.update(0,data,rn)
